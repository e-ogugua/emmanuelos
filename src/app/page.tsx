          ...
          >
            ...
            >
              <Button
                asChild
                size="lg"
                className="bg-gradient-to-r from-sky-500 via-blue-600 to-indigo-700 hover:from-sky-600 hover:via-blue-700 hover:to-indigo-800 text-white font-bold shadow-2xl hover:shadow-[0_0_40px_rgba(14,165,233,0.9),0_0_80px_rgba(99,102,241,0.7),0_0_120px_rgba(14,165,233,0.5)] transition-all duration-500 rounded-2xl px-10 py-5 text-xl"
              >
                <a
                  href="https://ceodev.vercel.app"
                  target="_blank"
